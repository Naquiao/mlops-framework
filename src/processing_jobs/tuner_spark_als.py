...
def main():
    ...
    als = ALS(implicitPrefs=True, userCol="idcuenta", itemCol="securityid",ratingCol="q", coldStartStrategy="drop")
    ...
    df = recommendations.select(recommendations.idcuenta,explode(recommendations.recommendations).alias("securityid_rating"))
